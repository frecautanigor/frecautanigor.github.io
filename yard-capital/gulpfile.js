...
gulp.task('scripts', function() {
	return gulp.src([
		...
		// 'app/libs/accordion-menu/js/script.js',
		// 'app/libs/mycart/js/jquery.mycart.min.js',
		// 'app/libs/jquery-filestyle/src/jquery-filestyle.min.js',
		// 'app/libs/Card-Slider/dist/js/jquery.cardslider.min.js',
		// 'node_modules/slick-carousel/slick/slick.min.js',
		// 'node_modules/simplebar/dist/simplebar.min.js',
		// 'node_modules/tingle.js/dist/tingle.min.js',
		'node_modules/swiper/js/swiper.min.js',
		'app/libs/jquery.textfill.min.js',
		'app/js/_libs.js',
...
function grid(done){
	...
	var options = require(gridOptPath);
