...
*/
function(e){e.fn.textfill=function(t){function i(){a.debug&&"undefined"!=typeof console&&void 0!==console.debug&&console.debug.apply(console,arguments)}function s(e,t,s,n,a,r){function o(e,t){var i=" / ";return e>t?i=" > ":e==t&&(i=" = "),i}i("[TextFill] "+e+" { font-size: "+t.css("font-size")+",Height: "+t.height()+"px "+o(t.height(),s)+s+"px,Width: "+t.width()+o(t.width(),n)+n+",minFontPixels: "+a+"px, maxFontPixels: "+r+"px }")}function n(e,t,i,n,a,r,o,l){for(s(e,t,a,r,o,l);o<Math.floor(l)-1;){var d=Math.floor((o+l)/2);t.css("font-size",d);var h=i.call(t);if(h<=n){if(o=d,h==n)break}else l=d;s(e,t,a,r,o,l)}return t.css("font-size",l),i.call(t)<=n&&s(e+"* ",t,a,r,o=l,l),o}var a=e.extend({debug:!1,maxFontPixels:40,minFontPixels:4,innerTag:"span",widthOnly:!1,success:null,fail:null,complete:null,explicitWidth:null,explicitHeight:null,changeLineHeight:!1,truncateOnFail:!1,allowOverflow:!1},t);return i("[TextFill] Start Debug"),this.each((function(){var t=e(a.innerTag+":first",this);if(i("[TextFill] Inner text: "+t.text()),i("[TextFill] All options: ",a),i("[TextFill] Maximum sizes: { Height: "+s+"px, Width: "+r+"px }"),t.is(":visible")){var s=a.explicitHeight||e(this).height(),r=a.explicitWidth||e(this).width(),o=t.css("font-size"),l=parseFloat(t.css("line-height"))/parseFloat(o),d=a.minFontPixels,h=0>=a.maxFontPixels?s:a.maxFontPixels,u=void 0;a.widthOnly?t.css("white-space","nowrap"):u=n("Height",t,e.fn.height,s,s,r,d,h),d=n("Width",t,e.fn.width,r,s,r,d,h),a.widthOnly?(t.css({"font-size":d}),a.changeLineHeight&&t.parent().css("line-height",l*d+"px")):(u=Math.min(u,d),t.css("font-size",u),a.changeLineHeight&&t.parent().css("line-height",l*u+"px")),i("[TextFill] Finished { Old font-size: "+o+", New font-size: "+t.css("font-size")+" }"),t.width()>r&&!a.allowOverflow||t.height()>s&&!a.widthOnly&&!a.allowOverflow?(t.css("font-size",o),a.fail&&a.fail(this),i("[TextFill] Failure { Current Width: "+t.width()+", Maximum Width: "+r+", Current Height: "+t.height()+", Maximum Height: "+s+" }")):a.success&&a.success(this)}else a.fail&&a.fail(this),i("[TextFill] Failure { Current Width: "+t.width()+", Maximum Width: "+r+", Current Height: "+t.height()+", Maximum Height: "+s+" }")})),a.complete&&a.complete(this),i("[TextFill] End Debug"),this}}("undefined"!=typeof module&&module.exports?require("jquery"):window.jQuery),document.addEventListener("DOMContentLoaded",(function(){var e=[].slice.call(document.querySelectorAll("img.lazy")),t=[].slice.call(document.querySelectorAll(".lazy-background")),i=[].slice.call(document.querySelectorAll("[data-bg]"));if("IntersectionObserver"in window){let s=new IntersectionObserver((function(e,t){e.forEach((function(e){if(e.isIntersecting){let t=e.target;t.src=t.dataset.src,t.srcset=t.dataset.srcset,t.classList.remove("lazy"),s.unobserve(t)}}))}));e.forEach((function(e){s.observe(e)}));let n=new IntersectionObserver((function(e,t){e.forEach((function(e){e.isIntersecting&&(e.target.classList.add("visible"),n.unobserve(e.target))}))}));t.forEach((function(e){n.observe(e)}));let a=new IntersectionObserver((function(e,t){e.forEach((function(e){if(e.isIntersecting){let t=e.target;t.style.backgroundImage="url("+t.dataset.bg+")",a.unobserve(t)}}))}));i.forEach((function(e){a.observe(e)}))}else e.forEach((function(e){e.src=e.dataset.src,e.srcset=e.dataset.srcset})),t.forEach((function(e){e.classList.add("visible")})),i.forEach((function(e){e.style.backgroundImage="url("+e.dataset.bg+")"}))})),document.addEventListener("DOMContentLoaded",(function(){$(".categories__item").each((function(){$(this).textfill({maxFontPixels:16,minFontPixels:3,innerTag:"a"})}));new Swiper(".card__image-container",{loop:!0,pagination:{el:".swiper-pagination",clickable:!0}})}));