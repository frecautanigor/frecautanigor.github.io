...
$(document).ready(function(){$("#main").fullpage({menu:".navigation__menu",anchors:["header","about","services","testimonials"],recordHistory:!1,onLeave:function(a,n,i){a>0&&"down"==i?$(".navigation").addClass("navigation__down"):1==n&&$(".navigation").removeClass("navigation__down")}});document.documentElement.clientWidth>480&&$("#main").fullpage({scrollBar:!0}),$(".navigation .hamburger").click(function(){$(this).toggleClass("is-active"),$(".navigation__mobile").addClass("block")}),$(".navigation__mobile .hamburger").click(function(){$(".navigation__mobile").removeClass("block"),$(".navigation .hamburger").removeClass("is-active")})});