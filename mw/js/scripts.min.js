...
$(document).ready(function(){$(".header-slider-items").owlCarousel({loop:!0,items:1,nav:!0,navContainer:".header-slider",navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']}),$(".s-about-slider").owlCarousel({loop:!0,items:1,nav:!1,dots:!0,autoplay:!0}),$(".s-services-slider-items").owlCarousel({loop:!0,margin:30,items:1,nav:!0,navContainer:".s-services-slider",navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsive:{0:{items:1,margin:0,nav:!1},480:{items:2},768:{items:3},992:{items:4},1200:{items:4}}}),$(".s-reviews-slider").owlCarousel({loop:!0,items:1,dots:!0,center:!0,autoplay:!0,autoplayTimeout:3e3});var e=$(".header-menu-mobile"),a=$(".header-menu-items"),i=$(".button-menu");$(i).on("click",function(t){e.toggleClass("active"),i.toggleClass("active"),t.preventDefault(),a.slideToggle(500)}),$(window).resize(function(){$(window).width()>760&&a.is(":hidden")&&a.removeAttr("style")}),$('a[href^="#"]').bind("click",function(e){var a=$(this);return $("html, body").stop().animate({scrollTop:$(a.attr("href")).offset().top},1e3),e.preventDefault(),!1}),$(".parallax-window").parallax({});new Waypoint({element:document.getElementById("basic-waypoint"),handler:function(){var e=$.animateNumber.numberStepFactories.separator(" ");$(".count").each(function(){var a=$(this).data("count");$(this).animateNumber({number:a,easing:"easeInQuad",numberStep:e},3e3)})}});var t=document.getElementById("bgvid"),n=document.querySelector(".s-video-button");window.matchMedia("(prefers-reduced-motion)").matches&&(t.addAttribute("autoplay"),t.pause(),n.innerHTML='<i class="fa fa-play"></i>'),n.addEventListener("click",function(){t.classList.toggle("stopfade"),t.paused?(t.play(),n.innerHTML='<i class="fa fa-pause"></i>'):(t.pause(),n.innerHTML='<i class="fa fa-play"></i>')}),$(".s-portfolio-gallery").justifiedGallery({rowHeight:250,margins:0}),$(".s-portfolio-gallery").magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,mainClass:"mfp-with-zoom mfp-img-mobile",gallery:{enabled:!0},zoom:{enabled:!0,duration:500,opener:function(e){return e.find("img")}}}),$(".s-services-slider-item").magnificPopup({type:"inline",preloader:!1,focus:"#username",modal:!0}),$(document).on("click",".close",function(e){e.preventDefault(),$.magnificPopup.close()}),$.ionTabs("#tabs_1")});