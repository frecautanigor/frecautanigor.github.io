...
$(document).ready(function(){$("#menu").mmenu({extensions:["pagedim-black","border-none","fx-listitems-slide"],navbars:[{position:"top",content:["<a class='fa fa-envelope' href=''><i class='icon icon-avatar'></i> Shop</a>"]},{position:"bottom",content:["<a class='fa fa-envelope' href=''><i class='icon icon-avatar'></i></a>","<a class='fa fa-twitter' href=''><i class='icon icon-avatar'></i></a>","<a class='fa fa-facebook' href=''><i class='icon icon-avatar'></i></a>"]}],offCanvas:{position:"right"}},{offCanvas:{pageSelector:"#mmenu"}});var a=$(".hamburger"),i=$("#menu").data("mmenu");a.on("click",function(){i.open()}),i.bind("open:finish",function(){setTimeout(function(){a.addClass("is-active")},100)}),i.bind("close:finish",function(){setTimeout(function(){a.removeClass("is-active")},100)}),$(".navigation .hamburger").click(function(){$(this).toggleClass("is-active")});var n=$(".is-animated");$(".second .is-animated__single"),$(".third .is-animated"),$(".third .is-animated__single"),$(".fourth .is-animated"),$(".fourth .is-animated__single");$("#main").fullpage({menu:".navigation__menu",anchors:["header","about","services","testimonials"],recordHistory:!1,responsiveWidth:768,responsiveHeight:480,scrollBar:!1,onLeave:function(a,i,e){a>0&&"down"==e?$(".navigation").addClass("navigation__down"):1==i&&$(".navigation").removeClass("navigation__down"),1==a&&2==i&&(n.addClass("animated fadeInUpBig"),n.eq(1).css("animation-delay",".3s"),n.eq(2).css("animation-delay",".6s"),n.eq(3).css("animation-delay",".9s"))}});var e=$("body").innerWidth();e<700?$(".navigation").addClass("navigation__down"):e>=700&&$(".navigation").removeClass("navigation__down"),$(".about__left").owlCarousel({loop:!0,items:1,dots:!0,autoplay:!0}),$(".services__slider").owlCarousel({loop:!0,nav:!0,margin:30,navText:['<i class="icon icon-left-arrow"></i>','<i class="icon icon-right-arrow"></i>'],navContainer:".services__slider",responsive:{0:{items:1,margin:0,nav:!1},480:{items:2},768:{items:3},992:{items:4},1200:{items:4}}})});