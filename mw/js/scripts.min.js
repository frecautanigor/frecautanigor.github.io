...
$(document).ready(function(){$("#menu").mmenu({extensions:["pagedim-black","border-none","fx-listitems-slide"],navbars:[{position:"top",content:["<a class='fa fa-envelope' href=''><i class='icon icon-avatar'></i> Shop</a>"]},{position:"bottom",content:["<a class='fa fa-envelope' href=''><i class='icon icon-avatar'></i></a>","<a class='fa fa-twitter' href=''><i class='icon icon-avatar'></i></a>","<a class='fa fa-facebook' href=''><i class='icon icon-avatar'></i></a>"]}],offCanvas:{position:"right"}},{offCanvas:{pageSelector:"#mmenu"}});var a=$(".hamburger"),n=$("#menu").data("mmenu");a.on("click",function(){n.open()}),n.bind("open:finish",function(){setTimeout(function(){a.addClass("is-active")},100)}),n.bind("close:finish",function(){setTimeout(function(){a.removeClass("is-active")},100)}),$("#main").fullpage({menu:".navigation__menu",anchors:["header","about","services","testimonials"],recordHistory:!1,responsiveHeight:480,onLeave:function(a,n,i){a>0&&"down"==i?$(".navigation").addClass("navigation__down"):1==n&&$(".navigation").removeClass("navigation__down")}});$("body").innerWidth()<700?$(".navigation").addClass("navigation__down"):$(".navigation").removeClass("navigation__down"),$(".navigation .hamburger").click(function(){$(this).toggleClass("is-active")})});