...
$(document).ready(function(){$("#fullpage").fullpage({}),$("#menu__mobile").mmenu({extensions:["fx-menu-zoom","fx-listitems-slide","border-none"],offCanvas:{position:"right"}});$("#menu__mobile").data("mmenu");$(".menu__right-humburger").click(function(){$(this).addClass("on")}),$("#mm-blocker").click(function(){$(".menu__right-humburger").removeClass("on")})});